...
import com.ami.instagramami.CommentActivity
import com.ami.instagramami.MainActivity
...
class PostAdapter(private val mContext: Context, private val mPost: List<Post>) : RecyclerView.Adapter<PostViewHolder>() {
    ...
    override fun onBindViewHolder(holder: PostViewHolder, position: Int) {
        ...
        numberOfLike(holder.likes, myPost.getPostId())
